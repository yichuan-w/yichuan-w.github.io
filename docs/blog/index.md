...
- [Defending Against the Training–Inference Numeric Mismatch in RL (Especially Linear Attention) — and Whether It Helps Async RL](training-inference-mismatch-rl.md) — August 2026. Making trainer/generator log-probs bit-exact for Gated DeltaNet, and why the guarantee quietly stops mattering under async RL.

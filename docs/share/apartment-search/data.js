...
const DATA = [
  ...
  { id: 'mayfair-station', name: 'Mayfair Station', area: 'El Cerrito',
    ...
    tour: 'appt', avail: '1 studio (#513, Aug 22) · ⚠ ZERO 2BR', availGood: true,
    ...
    note: '⚠ NO REAL ONLINE SCHEDULER. Both "Schedule a Tour" buttons on their site just anchor to <code>#contact</code> — the same plain contact form, no time slots. I verified this in the page source myself. ⚠ SUNDAY IS CLOSED (their site: "Monday-Saturday: 9 AM- 6 PM / Sunday: Closed"), so a Sunday tour is impossible. Sat 5 PM works since they close at 6. They also offer SELF-GUIDED tours (phone unlocks the unit) — easiest thing to arrange last-minute, ask for that. Pricing from their own floorplans page: Studio 387–396sf from $2,341 · Junior 1BR 455sf ask · <b>1BR 668–826sf from $2,373</b> · 2BR Corner 898–1,049sf ask · 2BR Large 1,065–1,097sf ask. 🎯 The 1BR is only $32/mo more than the studio for roughly double the space — that is the real find here. 2BR is not priced publicly, so you must ask. Fees (from their official PDF): app $62/adult · deposit $500 studio-1BR / $750 2BR · parking $100 lift or $200 stationary · trash $45/$55/$65 by size · renters insurance $17 · Esusu $5 · pet $50/mo + $400. Water/sewer/gas metered, electric via PG&E. Managed by Cornerstone Residential. ⚠⚠ TWO THINGS THAT PROBABLY KILL IT: (1) <b>ZERO 2BR available</b> — both 2BR plans show "call for pricing" and all six 2BR floor plans read 0 available, with no published waitlist. (2) Only <b>ONE studio</b>: #513, 387 sqft, $2,341, not ready until <b>Aug 22</b>. Historical studio rents in this building were $1,734–$2,204, so $2,341 is at the TOP of its own range. Other current stock is 1BR only: #621 664sf $2,689 Aug 6 · #318 695sf $2,568 Aug 26 · #425 695sf $2,612 Sep 9. ⚠ COMMUTE FAILS YOUR RULE: routed 6.1–7.3 mi at <b>15–16 min free-flow</b>, realistically <b>20–30 min</b> with I-80/Ashby traffic, plus Northside parking is bad. 📍 CORRECTION to what I first told you: it is near El Cerrito <b>del Norte</b> BART (0.41 mi, ~9 min walk), NOT El Cerrito Plaza. del Norte → Downtown Berkeley is a verified 8–9 min ride, but Downtown Berkeley → Soda Hall is 0.96 mi uphill, so door-to-door by BART is ~40–45 min. If a 2BR ever opens, historical 2x2 rents were $2,269–$3,432 for 898–1,097 sqft = <b>$1,135–$1,716 per person</b>, which would be excellent — that is the only reason to keep this building on the radar. No specials. No income requirement published — ask. Pre-screen without driving out: Matterport tours at my.matterport.com/show/?m=h27uRgJss2C (studio) and ?m=A9KVekUkwCt (2BR).' },
